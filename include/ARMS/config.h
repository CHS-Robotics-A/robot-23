...
#define LEFT_MOTORS topLMot, botLMot
#define RIGHT_MOTORS topRMot, botRMot
#define GEARSET gearboxDrive // RPM of chassis motors

// Ticks per inch
#define TPI quadTPI      			  // Encoder ticks per inch of forward robot movement
#define MIDDLE_TPI quadTPI          // Ticks per inch for the middle wheel

// Tracking wheel distances
#define TRACK_WIDTH traWhlTrack 		  // The distance between left and right wheels (or tracker wheels)
#define MIDDLE_DISTANCE midWhlDist  // Distance from middle wheel to the robot turning center

// Sensors
#define IMU_PORT 0                           // Port 0 for disabled
#define ENCODER_PORTS enc1p1, enc2p1, enc3p1                // Port 0 for disabled,
